...
An AI-powered study system that transforms lecture PDFs into structured exam preparation materials using the Anthropic Claude API.
...
- `src/ai_processor.py` — `call_claude(text, key) -> str` using Anthropic SDK (model: claude-sonnet-4-6)
...
- Dependencies: `anthropic`, `PyMuPDF`, `python-dotenv`
